...
| `monitoring_namespace`             | `monitoring`                                         | Kubernetes namespace for the stack.             |
...
| `kubeconfig_path`            | `/etc/rancher/k3s/k3s.yaml`                                     | Path to the kubeconfig file on the target host. |
