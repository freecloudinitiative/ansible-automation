...
The playbook asserts this value is non-empty before any node is modified. An empty value produces `https://:6443` and causes worker join to fail after k3s is already installed on the masters.
